...
export function Cart() {
  ...
  return (
    <CartCointainer>
      ...
      <ContainerSide>
        <DevilveryContainer>
          <TitleCart>Complete os dados de entrega</TitleCart>
          <DeliveryFormContainer>
            <SubTitleContainer>
              <IconText>
          ...
          <DeliveryFormContainer>
            ...
            <InputContainer>
              <ButtonPayment
                ...
                style={{
                  backgroundColor:
                    methodPayment === 'Cartão de Crédito' ? '#e6e5e5' : '',
                }}
              >
              ...
              <ButtonPayment
                ...
                style={{
                  backgroundColor:
                    methodPayment === 'Cartão de Debíto' ? '#e6e5e5' : '',
                }}
              >
